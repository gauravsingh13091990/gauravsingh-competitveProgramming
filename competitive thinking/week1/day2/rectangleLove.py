...
def find_rectangular_overlap(rect1, rect2):
    ...
    dict={}
    m = max(rect1['left_x'],rect2['left_x'])
    n = max(rect1['bottom_y'],rect2['bottom_y'])
    
    m1 = min((rect1['left_x']+rect1['width']),(rect2['left_x']+rect2['width']))
    n1 = min((rect1['bottom_y']+rect1['height']),(rect2['bottom_y']+rect2['height']))

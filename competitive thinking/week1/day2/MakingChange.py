...
def change_possibilities(amount, denominations,i=0):
    if amount < 0:
        return None
        ...
        for i in range(i, len(denominations)):
            ...
            if amount - coin < coin:
                comp = change_possibilities(amount - coin, denominations, i+1)
            else:
                comp = change_possibilities(amount - coin, denominations, i)
